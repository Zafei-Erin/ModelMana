//
//  ZhipuProviderPanel.swift
//  ModelMana
//
//  Zhipu provider dropdown panel
//

import SwiftUI

struct ZhipuProviderPanel: View {
    @ObservedProvider private var provider: ZhipuProvider

    init(provider: ZhipuProvider) {
